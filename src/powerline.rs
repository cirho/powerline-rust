...
impl Powerline {
    ...
    pub fn bg_str(&self, color: Color) -> String { format!("\\[\\e[48;5;{}m\\]", self.theme.get(color)) }
    pub fn fg_str(&self, color: Color) -> String { format!("\\[\\e[38;5;{}m\\]", self.theme.get(color)) }
    pub fn reset(&self) -> String { String::from("\\[\\e[0m\\]") }
}
